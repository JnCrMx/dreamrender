...
int main() {
    ...
    config.additional_device_extensions.emplace_back(vk::KHRVideoDecodeQueueExtensionName);
    config.additional_device_extensions.emplace_back(vk::KHRVideoDecodeH264ExtensionName);
    config.additional_device_extensions.emplace_back(vk::KHRVideoDecodeH265ExtensionName);
